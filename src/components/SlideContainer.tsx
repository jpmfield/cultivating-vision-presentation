  ...
  return (
    <div 
      ...
      className={cn(
        ...
        "print:max-w-none print:w-[210mm] print:h-[297mm] print:overflow-hidden",
        "border border-gray-100 relative bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] bg-[length:20px_20px]",
        className
      )}
    >
      <div className="slide-content bg-white z-10 relative p-4 rounded-md shadow-sm print:shadow-none print:p-3 print:overflow-hidden print:max-h-[277mm]">
        {children}
      </div>
    </div>
  );
